...
mod test {
    ...
    fn test_plan_satisfy_wsh() {
        ...
        let sk = secp256k1::SecretKey::from_secret_bytes(*b"sally was a secret key, she said").unwrap();
        ...
        let sighash = secp256k1::Message::from_digest(*b"michael was a message, amusingly");
